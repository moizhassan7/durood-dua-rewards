...
export const applyReferral = functions.https.onCall(async (data, context) => {
  ...
  let actualCode: string = referralCode;
  ...
  try {
    ...
    const result = await db.runTransaction(async (tx) => {
      ...
      // Prepare updates with type support
      interface UserUpdates {
        referredBy: string;
        referredAt: admin.firestore.FieldValue;
        totalCount: admin.firestore.FieldValue;
        monthCount: admin.firestore.FieldValue;
        referralCode?: string;
      }
