        ...
        <div className="max-w-md mx-auto space-y-6">
          <div className="bg-white rounded-2xl shadow-sm p-6" dir="rtl">
            ...
            <ul className="list-disc pr-5 mt-3 text-sm text-gray-600 space-y-2">
              ...
              <li>
                <li>
صرف پہلے تین نمبروں پر آنے والے افراد کو ہی انعام دیا جائے گا۔
انعام کا فیصلہ حاصل کردہ پوائنٹس کی بنیاد پر کیا جائے گا — جس کے پوائنٹس زیادہ ہوں گے، انعام اسی کو دیا جائے گا۔
</li><li>
  3,0000 پوائنٹس پر آپ درخواست (Request) دینے کے قابل ہو جاتے ہیں،
لیکن انعام صرف پہلے تین پوزیشن ہولڈرز کو ہی دیا جائے گا۔
باقی تمام افراد کی درخواستیں منسوخ کر دی جائیں گی۔
لہذا پہلے تین میں شامل ہونے کے لیے  زیادہ سے زیادہ درود شریف پڑھیں</li>
